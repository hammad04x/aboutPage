    ...
    <section className="py-24 px-6 md:px-12 lg:px-24 bg-[var(--color-secondary)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Card 1 */}
          <div className="group p-10 bg-[#141414] rounded-xl border border-[var(--color-third)]/10 transition-all duration-300 hover:bg-gradient-to-br hover:from-[#141414] hover:to-[#0b1a30] hover:border-[var(--color-fourth)]">
