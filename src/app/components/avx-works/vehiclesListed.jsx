...
export default function VehiclesListed() {
    ...
    return (
        <section className="py-24 px-6 md:px-12 lg:px-24 bg-[var(--color-secondary)] font-secondary">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm p-8 md:p-12">
                    ...
                    <div className="grid lg:grid-cols-2 gap-14 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-[var(--color-third)] text-sm md:text-base leading-relaxed mb-10 max-w-lg">
                                ...
                                {points.map((point, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-[9px] font-bold text-[var(--color-third)] uppercase tracking-tighter">Verified</span>
